...
void findSuccessor_exit(Node *n, Stack *stack);

void findPredecessor_exit(Node *n, void *stack);
...
void findSuccessor_entry(Node *n, Stack *stack)
{
  ...
  stack = pushStack(stack, newStackItem(n->id, findSuccessor_exit));
...
void findPredecessor_entry(Node *n, Stack *stack)
{
  ...
  if ((n->id == n->successor) || 
    ...
    stack = pushStack(stack, newStackItem(n->id, findPredecessor_exit));
    topStack(stack)->data.key = top->data.key;
