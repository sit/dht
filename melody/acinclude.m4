dnl $Id: acinclude.m4,v 1.2 2003/01/09 20:48:35 jsr Exp $
...
LDEPS='$(LIBDHASH) $(LIBMERKLE) $(LIBCHORD) $(LIBCHORDSVC) $(LIBCHORDSFSRODB)'" $LDADD"
LDADD='$(LIBDHASH) $(LIBMERKLE) $(LIBCHORD) $(LIBCHORDSVC) $(LIBCHORDSFSRODB) $(DB3_LIB)'" $LDEPS"
AC_SUBST(LDEPS)
AC_SUBST(LDADD)
])
